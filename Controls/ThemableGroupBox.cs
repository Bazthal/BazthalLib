...
namespace BazthalLib.Controls
{
    ...
    public class ThemableGroupBox : GroupBox, IThemableControl
    {
        ...
        public void ApplyTheme(ThemeColors colors)
        {
            ...
            {
                DebugUtils.LogIf(colors == null, "Theming", "ThemeableGroupBox", "ThemeColors is null.", logLevel: LogLevel.Error);
                DebugUtils.LogIf(!_useThemeColors, "Theming", "ThemableGroupBox", "Theming is disabled.", logLevel: LogLevel.Info);
            }
