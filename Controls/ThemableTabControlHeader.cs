...
namespace BazthalLib.Controls
{
    ...
    public class ThemableTabControlHeader : FlowLayoutPanel, IThemableControl
    {
        ...
        public void ApplyTheme(ThemeColors colors)
        {
            ...
            {
                DebugUtils.LogIf(colors == null, "Theming", "ThemableTabControlHeader", "ThemeColors is null.", logLevel: LogLevel.Error);
                DebugUtils.LogIf(!_useThemeColors, "Theming", "ThemableTabControlHeader", "Theming is disabled.", logLevel: LogLevel.Info);
                return;
            }
