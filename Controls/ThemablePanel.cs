...
namespace BazthalLib.Controls
{
    ...
    public class ThemablePanel : Panel, IThemableControl
    {
        ...
        public void ApplyTheme(ThemeColors colors)
        {
            ...
            {
                DebugUtils.LogIf(colors == null, "Theming", "ThemablePanel", "ThemeColors is null.", logLevel: LogLevel.Error);
                DebugUtils.LogIf(!_useThemeColors, "Theming", "ThemablePanel", "Theming is disabled.", logLevel: LogLevel.Info);
                return;
            }
